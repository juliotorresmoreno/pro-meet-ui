...
export const translations = {
    ...
    cases: [
      {
        ...
        description:
          "Streamline your meeting scheduling without back-and-forth emails.",
        icon: <FaUserTie className="text-primary" size="1.5em" />,
      },
      {
        title: "Sales Teams",
        description:
          "Let prospects book meetings directly in your available slots.",
        icon: <FaUsers className="text-primary" size="1.5em" />,
      },
      {
        title: "Educators & Trainers",
        description:
          "Manage student appointments and consultations efficiently.",
  ...
  es: {
    ...
    subtitle:
      "Soluciones de programación optimizadas para cada necesidad profesional",
    cases: [
      {
        title: "Ejecutivos y Gerentes",
        description:
          "Agiliza la programación de reuniones sin correos interminables.",
        icon: <FaUserTie className="text-primary" size="1.5em" />,
      },
      {
        title: "Equipos de Ventas",
        description:
          "Permite que los prospectos agenden reuniones directamente en tus horarios disponibles.",
        icon: <FaUsers className="text-primary" size="1.5em" />,
      },
      {
        title: "Educadores y Capacitadores",
        description:
          "Gestiona citas y consultas con estudiantes de manera eficiente.",
        icon: <FaGraduationCap className="text-primary" size="1.5em" />,
      },
      {
        title: "Reclutadores",
        description:
          "Simplifica la programación de entrevistas con candidatos.",
        icon: <FaCalendarCheck className="text-primary" size="1.5em" />,
      },
      {
        title: "Consultores",
        description:
          "Ofrece una experiencia profesional de reserva a tus clientes.",
        icon: <FaHandshake className="text-primary" size="1.5em" />,
      },
      {
        title: "Freelancers",
        description:
          "Gestiona reuniones con clientes sin complicaciones de agenda.",
        icon: <FaLaptopCode className="text-primary" size="1.5em" />,
      },
    ],
  },
  fr: {
    ...
    subtitle:
      "Solutions de planification optimisées pour chaque besoin professionnel",
    cases: [
      {
        title: "Cadres & Managers",
        description:
          "Simplifiez la planification de vos réunions sans échanges de mails interminables.",
        icon: <FaUserTie className="text-primary" size="1.5em" />,
      },
      {
        title: "Équipes Commerciales",
        description:
          "Permettez aux prospects de réserver des réunions directement dans vos créneaux disponibles.",
        icon: <FaUsers className="text-primary" size="1.5em" />,
      },
      {
        title: "Éducateurs & Formateurs",
        description:
          "Gérez efficacement les rendez-vous et consultations avec les étudiants.",
        icon: <FaGraduationCap className="text-primary" size="1.5em" />,
      },
      {
        title: "Recruteurs",
        description:
          "Simplifiez la planification des entretiens avec les candidats.",
        icon: <FaCalendarCheck className="text-primary" size="1.5em" />,
      },
      {
        title: "Consultants",
        description:
          "Offrez une expérience de réservation professionnelle à vos clients.",
        icon: <FaHandshake className="text-primary" size="1.5em" />,
      },
      {
        title: "Indépendants",
  ...
  ja: {
    ...
    subtitle:
      "あらゆる専門的なニーズに最適化されたスケジューリングソリューション",
    cases: [
      {
        title: "経営陣とマネージャー",
